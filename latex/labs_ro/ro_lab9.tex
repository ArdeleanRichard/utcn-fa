...
În acest laborator se va implementa algoritmul BFS (căutarea în lățime), conform secțiunii 22.2 din \cite{cormen}.
...
În \texttt{bfs.cpp}, trebuie completată funcția \texttt{bfs()} care primește ca parametri un pointer la structura de tip \texttt{Graph} și nodul de start \texttt{s} de tip \texttt{Node*}. Funcția va aplica algoritmul BFS conform secțiunii 22.2 din \cite{cormen}.
